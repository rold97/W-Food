...
const NavMobile = ({ containerStyles, iconStyles, linkStyles }) => {
  ...
  return (
    <div className={containerStyles}>
      ...
      >
        <RiMenu2Line className="text-3xl text-white hover:text-orange transition-all duration-200" />
      </div>
      <aside
        className={`${
            ...
            {links.map((link, i) => {
              return (
                <ScrollLink
                  ...
                  offset={link.offset}
                  smooth={false}
                  className="flex items-center gap-x-3  hover:text-orange transition-all duration-300 cursor-pointer"
                >
